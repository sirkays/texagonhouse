...
export function AdvancedReporting() {
  ...
  const exportFormats = [
    ...
    },
    {
      ...
      description: "Raw data with pivot tables",
    },
  ...
  const generateCustomReport = () => {
    ...
    alert(
      "Custom report generation started. You will receive an email when ready."
    );
  };
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Live platform performance indicators
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <TabsContent value="templates" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ready-to-use reports for common analytics needs
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="custom" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create personalized reports with specific metrics and date
                ranges
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="analytics" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Set up alerts for important metrics and thresholds
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Trigger when DAU drops below 2,500
                      </p>
                    </div>
                  </div>
                ...
                <div className="p-3 border rounded-lg flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Notify when monthly revenue exceeds ₦3M
                      </p>
                    </div>
                  </div>
                  <Badge variant="outline">Active</Badge>
