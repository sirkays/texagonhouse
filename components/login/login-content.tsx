...
// // //   // Control splash animation duration
// // //   useEffect(() => {
// // //     if (animate) {
// // //       const timer = setTimeout(() => setAnimate(false), 7000);
...
// //           <h2 className="text-5xl font-bold text-white mb-4">
// //             <span
// //               className={`inline-block animate-bounce [animation-iteration-count:1]`}
// //               style={{
// //                 animationDelay: "0s",
// //                 fontSize: "5rem",
// //                 fontWeight: "bold",
...
// //         <span
// //           key={index}
// //           className={`inline-block opacity-0 animate-[fadeInBounce_1s_forwards] ${className}`}
// //           style={{
// //             ...wordStyle,
