...
export function LiveSessionManager() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      case "live":
        return <div className="w-1.5 h-1.5 xs:w-2 xs:h-2 bg-red-500 rounded-full animate-pulse" />
      case "scheduled":
        return <Clock className="h-2.5 w-2.5 xs:h-3 xs:w-3" />
      case "completed":
        return <div className="w-1.5 h-1.5 xs:w-2 xs:h-2 bg-green-500 rounded-full" />
      default:
        return null
    }
  }
  ...
  return (
    <div className="space-y-4 p-3 xs:p-4 sm:p-6 max-w-full mx-auto">
      <div>
        <h1 className="text-xl xs:text-2xl sm:text-3xl font-bold">Live Session Manager</h1>
        <p className="text-muted-foreground text-xs xs:text-sm sm:text-base">Schedule and manage live teaching sessions</p>
      </div>
      ...
      <Tabs defaultValue="sessions" className="space-y-4 xs:space-y-6">
        ...
        <TabsContent value="sessions" className="space-y-4 xs:space-y-6">
          <div className="grid gap-4 xs:gap-6 grid-cols-1 md:grid-cols-2">
            <Card>
              <CardHeader>
                <CardTitle className="text-base xs:text-lg sm:text-xl">Session Calendar</CardTitle>
                <CardDescription className="text-xs xs:text-sm sm:text-base">View your scheduled sessions</CardDescription>
              </CardHeader>
              <CardContent>
                <Calendar
                  mode="single"
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base xs:text-lg sm:text-xl">Quick Stats</CardTitle>
                <CardDescription className="text-xs xs:text-sm sm:text-base">Your session overview</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 xs:space-y-4">
                <div className="flex items-center justify-between p-2 xs:p-3 bg-blue-50 rounded-lg">
                  <div className="flex items-center gap-1 xs:gap-2">
                    ...
                    <span className="font-medium text-xs xs:text-sm sm:text-base">Scheduled</span>
                  </div>
                  <span className="text-lg xs:text-xl sm:text-2xl font-bold text-blue-600">3</span>
                </div>
                <div className="flex items-center justify-between p-2 xs:p-3 bg-green-50 rounded-lg">
                  <div className="flex items-center gap-1 xs:gap-2">
                    ...
                    <span className="font-medium text-xs xs:text-sm sm:text-base">Total Students</span>
                  </div>
                  <span className="text-lg xs:text-xl sm:text-2xl font-bold text-green-600">75</span>
                </div>
                <div className="flex items-center justify-between p-2 xs:p-3 bg-purple-50 rounded-lg">
                  <div className="flex items-center gap-1 xs:gap-2">
                    ...
                    <span className="font-medium text-xs xs:text-sm sm:text-base">Hours This Week</span>
                  </div>
                  <span className="text-lg xs:text-xl sm:text-2xl font-bold text-purple-600">12</span>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 xs:gap-4">
                <div>
                  <CardTitle className="text-base xs:text-lg sm:text-xl">Upcoming Sessions</CardTitle>
                  <CardDescription className="text-xs xs:text-sm sm:text-base">Manage your scheduled live sessions</CardDescription>
                </div>
                <Button onClick={handleNewSession} className="text-xs xs:text-sm sm:text-base">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 xs:gap-4">
                    <div className="space-y-1 xs:space-y-2">
                      <div className="flex items-center gap-2">
                        <h3 className="font-semibold text-xs xs:text-sm sm:text-base">{session.title}</h3>
                        <Badge className={`${getStatusColor(session.status)} text-[0.65rem] xs:text-xs sm:text-sm`}>
                      ...
                      <p className="text-[0.65rem] xs:text-xs sm:text-sm text-muted-foreground">{session.description}</p>
                    ...
                    <div className="flex gap-1 xs:gap-2">
                      ...
                      {session.status === "scheduled" && (
                        <>
                          <Button variant="outline" size="sm" onClick={() => handleEditSession(session)} className="p-1 xs:p-2">
                            <Edit className="h-2.5 w-2.5 xs:h-3 xs:w-3" />
                          </Button>
                          <Button variant="outline" size="sm" onClick={() => handleDeleteSession(session)} className="p-1 xs:p-2">
        ...
        <TabsContent value="schedule" className="space-y-4 xs:space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-base xs:text-lg sm:text-xl">Schedule New Session</CardTitle>
              <CardDescription className="text-xs xs:text-sm sm:text-base">Create a new live teaching session</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3 xs:space-y-4">
              <div className="grid gap-3 xs:gap-4 grid-cols-1 sm:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="session-title" className="text-xs xs:text-sm sm:text-base">Session Title</Label>
                  <Input
                    id="session-title"
                ...
                <div className="space-y-2">
                  <Label htmlFor="subject" className="text-xs xs:text-sm sm:text-base">Subject</Label>
                  <Select
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="programming" className="text-xs xs:text-sm sm:text-base">Programming</SelectItem>
                      <SelectItem value="mathematics" className="text-xs xs:text-sm sm:text-base">Mathematics</SelectItem>
                      <SelectItem value="science" className="text-xs xs:text-sm sm:text-base">Science</SelectItem>
                      <SelectItem value="language" className="text-xs xs:text-sm sm:text-base">Language Arts</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="description" className="text-xs xs:text-sm sm:text-base">Description</Label>
                <Textarea
                  id="description"
              ...
              <div className="grid gap-3 xs:gap-4 grid-cols-1 sm:grid-cols-3">
                <div className="space-y-2">
                  <Label htmlFor="date" className="text-xs xs:text-sm sm:text-base">Date</Label>
                  <Input
                    id="date"
                    type="date"
                ...
                <div className="space-y-2">
                  <Label htmlFor="time" className="text-xs xs:text-sm sm:text-base">Time</Label>
                  <Input
                    id="time"
                    type="time"
                ...
                <div className="space-y-2">
                  <Label htmlFor="duration" className="text-xs xs:text-sm sm:text-base">Duration (minutes)</Label>
                  <Input
                    id="duration"
                    type="number"
                    placeholder="60"
              ...
              <div className="space-y-2">
                <Label htmlFor="max-students" className="text-xs xs:text-sm sm:text-base">Maximum Students</Label>
                <Input
                  id="max-students"
                  type="number"
                  placeholder="30"
              ...
              <div className="flex flex-col sm:flex-row gap-2 xs:gap-3 xs:gap-4">
                <Button variant="outline" className="flex-1 bg-transparent text-xs xs:text-sm sm:text-base" onClick={handleSaveDraft}>
                  Save Draft
                </Button>
                <Button className="flex-1 text-xs xs:text-sm sm:text-base" onClick={handleScheduleSession}>
        ...
        <TabsContent value="live" className="space-y-4 xs:space-y-6">
          <div className={`grid gap-4 xs:gap-6 ${isChatOpen ? "grid-cols-1 md:grid-cols-3" : "grid-cols-1"}`}>
            <div className={isChatOpen ? "md:col-span-2" : "col-span-1"}>
              <Card>
                <CardHeader>
                  <CardTitle className="text-base xs:text-lg sm:text-xl">Live Session Controls</CardTitle>
                  <CardDescription className="text-xs xs:text-sm sm:text-base">Control your live session</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4 xs:space-y-6">
                  <div className="bg-gray-900 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                    {isSessionStarted && videoStream ? (
                      ...
                      <div className="text-center text-white">
                        ...
                        <p className="text-base xs:text-lg sm:text-xl">Your video feed will appear here</p>
                        <p className="text-xs xs:text-sm sm:text-base opacity-75">Click "Start Session" to begin</p>
                      </div>
                    )}
                  ...
                  <div className="flex flex-wrap justify-center gap-2 xs:gap-3">
                    <Button
                      ...
                      className={`text-xs xs:text-sm sm:text-base ${isMuted ? "bg-red-100 text-red-700 border-red-300" : ""}`}
                    >
                      {isMuted ? <MicOff className="mr-1 xs:mr-2 h-3 w-3 xs:h-4 xs:w-4" /> : <Mic className="mr-1 xs:mr-2 h-3 w-3 xs:h-4 xs:w-4" />}
                      {isMuted ? "Unmute" : "Mute"}
                    </Button>
                    <Button
                      variant="outline"
                      ...
                      className={`text-xs xs:text-sm sm:text-base ${!isCameraOn ? "bg-red-100 text-red-700 border-red-300" : ""}`}
                    >
                      {isCameraOn ? <Camera className="mr-1 xs:mr-2 h-3 w-3 xs:h-4 xs:w-4" /> : <VideoOff className="mr-1 xs:mr-2 h-3 w-3 xs:h-4 xs:w-4" />}
                      Camera
                    </Button>
                    <Button
                      size="lg"
                      className={`text-xs xs:text-sm sm:text-base ${isSessionStarted ? "bg-red-600 hover:bg-red-700" : "bg-green-600 hover:bg-green-700"}`}
                    ...
                    <Button
                      ...
                      className={`text-xs xs:text-sm sm:text-base ${isScreenSharing ? "bg-blue-100 text-blue-700 border-blue-300" : ""}`}
                    >
                    ...
                    <Button
                      ...
                      className={`text-xs xs:text-sm sm:text-base ${isChatOpen ? "bg-blue-100 text-blue-700 border-blue-300" : ""}`}
                    >
                  ...
                  <div className="grid gap-3 xs:gap-4 grid-cols-1 sm:grid-cols-2">
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-sm xs:text-base sm:text-lg">Session Info</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-2">
                        <div className="flex justify-between text-[0.65rem] xs:text-xs sm:text-sm">
                          <span>Status:</span>
                          <Badge className={`${isSessionStarted ? "bg-red-100 text-red-700" : "bg-gray-100 text-gray-700"} text-[0.65rem] xs:text-xs sm:text-sm`}>
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-sm xs:text-base sm:text-lg">Quick Actions</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-2">
                ...
                <Card className="h-[400px] xs:h-[500px] sm:h-[600px] flex flex-col">
                  <CardHeader className="flex-shrink-0 border-b">
                    <div className="flex items-center justify-between">
                      <div>
                        <CardTitle className="text-sm xs:text-base sm:text-lg">Live Chat</CardTitle>
                      ...
                      <Button variant="ghost" size="sm" onClick={() => setIsChatOpen(false)} className="p-1 xs:p-2">
                      ...
                      <div className="space-y-3 xs:space-y-4">
                        {chatMessages.map((message) => (
                          ...
                          >
                            ...
                            >
                              {!message.isTeacher && (
                                <div className="text-[0.65rem] xs:text-xs sm:text-sm font-medium text-blue-600 mb-1">{message.user}</div>
                              )}
                              <div className="text-[0.65rem] xs:text-xs sm:text-sm">{message.message}</div>
                              <div className={`text-[0.6rem] xs:text-[0.65rem] sm:text-xs mt-1 ${message.isTeacher ? "text-blue-100" : "text-gray-500"}`}>
                                {message.time}
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="flex gap-1 xs:gap-2">
                        <div className="flex-1 relative">
                          ...
                          <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1">
                            <Button variant="ghost" size="sm" className="h-5 w-5 xs:h-6 xs:w-6 p-0">
                        ...
                        <Button onClick={handleSendMessage} size="sm" className="p-1 xs:p-2">
      ...
      <Dialog open={isScreenShareOpen} onOpenChange={setIsScreenShareOpen}>
        <DialogContent className="max-w-[90vw] sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-base xs:text-lg sm:text-xl">Share Your Screen</DialogTitle>
            <DialogDescription className="text-xs xs:text-sm sm:text-base">Choose what you'd like to share with your students</DialogDescription>
          </DialogHeader>
            ...
            >
              <div className="flex items-center gap-3 xs:gap-4">
                ...
                <div className="text-left">
                  ...
                  <div className="text-[0.65rem] xs:text-xs sm:text-sm text-muted-foreground">Share everything on your screen</div>
                </div>
              </div>
            </Button>
            <Button
            ...
            >
              <div className="flex items-center gap-3 xs:gap-4">
                ...
                <div className="text-left">
                  ...
                  <div className="text-[0.65rem] xs:text-xs sm:text-sm text-muted-foreground">Share a specific application</div>
                </div>
              </div>
            </Button>
            <Button
            ...
            >
              <div className="flex items-center gap-3 xs:gap-4">
                ...
                <div className="text-left">
                  ...
                  <div className="text-[0.65rem] xs:text-xs sm:text-sm text-muted-foreground">Share a specific browser tab</div>
                </div>
              </div>
            </Button>
          </div>
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsScreenShareOpen(false)} className="text-xs xs:text-sm sm:text-base">
              Cancel
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-[90vw] sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-base xs:text-lg sm:text-xl">Edit Session</DialogTitle>
            <DialogDescription className="text-xs xs:text-sm sm:text-base">Update session details</DialogDescription>
          </DialogHeader>
          {selectedSession && (
            <div className="space-y-3 xs:space-y-4">
              <div className="space-y-2">
                <Label className="text-xs xs:text-sm sm:text-base">Session Title</Label>
                <Input defaultValue={selectedSession.title} className="text-xs xs:text-sm sm:text-base" />
              </div>
              <div className="space-y-2">
                <Label className="text-xs xs:text-sm sm:text-base">Description</Label>
                <Textarea defaultValue={selectedSession.description} className="text-xs xs:text-sm sm:text-base" />
              </div>
              <div className="grid gap-3 xs:gap-4 grid-cols-1 sm:grid-cols-2">
                <div className="space-y-2">
                  <Label className="text-xs xs:text-sm sm:text-base">Date</Label>
                  <Input type="date" defaultValue={selectedSession.date} className="text-xs xs:text-sm sm:text-base" />
                </div>
                <div className="space-y-2">
                  <Label className="text-xs xs:text-sm sm:text-base">Time</Label>
                  <Input type="time" defaultValue={selectedSession.time} className="text-xs xs:text-sm sm:text-base" />
                </div>
              </div>
            </div>
          )}
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent className="max-w-[90vw] sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-base xs:text-lg sm:text-xl">Delete Session</DialogTitle>
