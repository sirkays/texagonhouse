...
//                 ? classes.find((c) => c.id === filters.classroom_id)?.name
//                 : "All Classes"}
...
//                     className={cn(
//                       "mr-2 h-4 w-4",
//                       !filters.classroom_id ? "opacity-100" : "opacity-0",
//                     )}
//                   />
//                   All Classes
//                 </CommandItem>
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              ...
              className="w-full sm:w-48 justify-between">
              {filters.course_id
                ? courses.find((c) => c.id === filters.course_id)?.name
                : "All Courses"}
              <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
            </Button>
          </PopoverTrigger>
              ...
              <CommandGroup>
                <CommandItem
                  ...
                  <Check
                    className={cn(
                      "mr-2 h-4 w-4",
                      !filters.course_id ? "opacity-100" : "opacity-0",
                    )}
                  />
                  All Courses
                </CommandItem>
