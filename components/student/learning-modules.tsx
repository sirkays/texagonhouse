                            ...
                            <div className="relative aspect-video w-full flex-shrink-0 bg-gray-100 overflow-hidden">
                              {video.cover_image ? (
                                <>
                                  ...
                                  />
                                  <div className="fallback-icon absolute inset-0 flex items-center justify-center hidden bg-gray-100">
                              ...
                              {/* Optional subtle overlay gradient like many Udemy previews */}
                        ...
                        return (
                          <Card
                            ...
                            <CardContent className="flex flex-1 flex-col gap-4 p-4 sm:p-5">
                              {/* Icon + Title + Course – top priority */}
                              <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1 space-y-1">
                                  <CardTitle className="line-clamp-2 text-base font-bold leading-tight tracking-tight sm:text-lg md:text-xl text-gray-900 group-hover:text-[#EF7B55] transition-colors">
                                    {audio.title}
                                  </CardTitle>
                              ...
                              {/* Metadata – compact row on larger screens, wraps naturally on mobile */}
                              <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs text-gray-500 sm:text-sm">
                                <div className="flex items-center gap-1.5">
                                  <Clock className="h-3.5 w-3.5" />
                              ...
                              {/* Actions – full-width mobile, side-by-side desktop */}
                              <div className="mt-auto flex flex-col gap-3 pt-4 sm:flex-row sm:items-center sm:gap-4">
                                <Button
                                  onClick={() => handlePlayAudio(audio)}
                                  disabled={!audio.url}
                      ...
                      {getPaginatedItems(
                        ...
                        return (
                          <Card
                            ...
                            <CardContent className="flex flex-1 flex-col gap-4 p-4 sm:p-5">
                              {/* Icon + Title + Course – strong top section */}
                              <div className="flex items-start gap-4">
                                <div className="relative flex h-16 w-16 shrink-0 items-center justify-center rounded-lg bg-[#f797712f]">
                                  <FileText className="h-8 w-8 text-[#EF7B55]" />
                                  {isSaved && (
                              ...
                              {/* Metadata – compact, wraps nicely on small screens */}
                              <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs text-gray-500 sm:text-sm">
                                <div className="flex items-center gap-1.5">
                              ...
                              {/* Actions – full width on mobile, side-by-side on larger screens */}
                              <div className="mt-auto flex flex-col gap-3 pt-4 sm:flex-row sm:items-center sm:gap-4">
                                <Button
                                  onClick={() => handlePreviewPdf(pdf)}
                                  disabled={!pdf.url}
