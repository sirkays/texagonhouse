              ...
              <div className="flex items-center space-x-3 sm:space-x-4 overflow-hidden">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1 flex-wrap">
                    <Badge className={`${getLevelColor(child.level)} text-xs sm:text-sm`}>
                      {child.level}
                    </Badge>
          ...
          <div className="space-y-4">
            {paginatedRewards.map((reward, index) => (
              <div key={index} className="p-3 sm:p-4 border rounded-lg space-y-3">
                ...
                <div className="space-y-2">
                  <h5 className="text-xs sm:text-sm font-medium">Eligible Children:</h5>
              ...
              <PaginationContent>
                ...
                <PaginationItem>
                  <PaginationNext
                    onClick={() => handleRewardsPageChange(rewardsPage + 1)}
                    className={
                      rewardsPage === totalRewardsPages ? "pointer-events-none opacity-50" : ""
                    }
                  />
                </PaginationItem>
              </PaginationContent>
