...
//     setIsLoading(true);
//     try {
//       const res = await fetch("/api/parent/children-list", {
...
//     try {
//       const res = await fetch("/api/parent/time-periods", {
//         headers: {"Content-Type": "application/json"},
//       });
//       const data = await res.json();
//       if (!res.ok)
...
//       }).toString();
//       const res = await fetch(`/api/parent/children-progress?${params}`, {
//         headers: {"Content-Type": "application/json"},
//       });
//       const data = await res.json();
//       if (!res.ok)
...
//       (sum, child) =>
//         sum +
//         (child[selectedPeriod === "week" ? "weeklyStats" : "monthlyStats"]
//           ?.hoursStudied || 0),
//       0
//     );
//     const totalTests = childrenData.reduce(
...
//       {isLoading && <p className="text-center">Loading progress data...</p>}
//       {error && (
//         <div className="text-center">
//           <p className="text-red-600">{error}</p>
//           {error.includes("Unauthorized") && (
//             <p className="text-red-600">
//               Please ensure you are logged in or contact support.
//             </p>
//           )}
//           <Button
//             variant="outline"
...
//                 <CardContent>
//                   <div className="space-y-3">
//                     {child.subjects.map((subject: any, index: any) => (
//                       <div
//                         key={index}
//                         className="flex flex-col gap-3 p-3 border rounded-lg">
//                         <div className="flex items-center justify-between flex-wrap gap-2">
...
//   averageScore: number;
//   streak: number;
//   coursesCompleted?: number; // Optional per docs
// }
...
//   // Fetch progress on filter changes
//   useEffect(() => {
//     if (!isInitialLoading) {
//       fetchProgressData();
//     }
...
//     } catch (err: any) {
//       console.error(err);
//       // Don't set global error here—handle in UI
//     }
//   };
...
//     if (period === "month") return "monthlyStats";
//     // Fallback for quarter/semester/year—suggest backend update for dynamic stats
//     console.warn(
//       `No specific stats for period "${period}"; using monthlyStats`
//     );
//     return "monthlyStats";
//   };
...
//   const showContent = !isInitialLoading && !error && progressData.length > 0;
...
//               </Card>
//             ))}
//           {!showContent && !error && selectedData.length === 0 && (
