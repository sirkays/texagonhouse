...
//   const {cartItems, updateQuantity, removeFromCart, setBuyNowProduct} =
//     useCart();
...
//               {bnplOptions.map((opt) => (
//                 <div key={opt.provider} className="border rounded-lg p-3">
...
//                       {opt.installments} payments of ${opt.amount.toFixed(2)}
//                     </p>
//                     <p className="text-muted-foreground">
//                       0% interest, no fees
//                     </p>
