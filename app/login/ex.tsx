// Updated login page: app/login/page.tsx (relevant changes only; replace the handleForgotPasswordSubmit function and imports if needed)
"use client";
...
export default function LoginPage() {
  ...
  const handleForgotPasswordSubmit = async (e: any) => {
    ...
    try {
      ...
      console.log("[LoginPage] Reset email sent:", result.detail);
