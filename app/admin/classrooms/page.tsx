...
//         method = "PATCH";
//         // Note: This assumes a dynamic route at /api/admin/classrooms/[id]/route.ts handles PATCH
//         // If not implemented, update locally or implement the route
...
//       // Note: This assumes a dynamic route at /api/admin/classrooms/[id]/route.ts handles DELETE
//       // If not implemented, update locally or implement the route
//       const response = await fetch(url, {
//         method: "DELETE",
//         headers: {
