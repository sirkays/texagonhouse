...
//       // On success, sessions are revoked, so sign out and redirect to login
...
//           {/* Logo + Branding (exact match to login) */}
...
//           {/* Heading (styled exactly like login) */}
//           <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-900">
//             Change your password
//           </h2>

//           {/* Form (exact spacing, styling, icons, height, focus ring, etc.) */}
...
//             {/* Error (exact same styling as login error) */}
//             {error && (
...
//             {/* Submit Button (exact same as login: gradient, large, loading spinner) */}
//             <Button
//               type="submit"
//               variant="gradient"
...
//       {/* Right branding panel (100% identical to login) */}
//       <div
...
//         style={{backgroundImage: "url('/texagon_sva.svg')"}}></div>
//     </div>
//   );
// }
...
export default function ChangePassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log(
        "Submitting password change with session token:",
        sessionToken,
      );
      const response = await fetch("/api/change-password", {
        method: "POST",
      ...
      // If auto-login succeeded → redirect to dashboard or home
      router.push("/dashboard"); // ← change this to your actual protected route
    } catch (err) {
