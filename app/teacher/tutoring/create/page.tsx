...
export default function CreatePrivateTutoringPage() {
    ...
    const handleCreatePrivateSession = async () => {
        ...
        if (!privateCourseId || !ratePerHour || availableDays.length === 0 || !privateTitle.trim() || tutoringDurationDays < 1 || !privateNotes.trim()) {
            setError(
        ...
        <div className="max-w-3xl mx-auto p-4 sm:p-6 space-y-6">
            ...
            <Card className="w-full max-w-[700px] mx-auto overflow-hidden rounded-lg border shadow-sm">
                <CardHeader className="p-4 sm:p-6 bg-background border-b">
                    <CardTitle className="text-xl font-bold">Create Private Session</CardTitle>
                ...
                <CardContent className="p-4 sm:p-6 space-y-4">
                    ...
                    <div className="grid gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="course">Course <span className="text-[#EF7B55]">*</span></Label>
                            <Select
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="title">Title <span className="text-[#EF7B55]">*</span></Label>
                            <input
                                id="title"
                                type="text"
                                value={privateTitle}
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="rate">Rate per hour <span className="text-[#EF7B55]">*</span></Label>
                                ...
                                {[
                                    ...
                                    <Button
                                        ...
                                        className={cn(
                                            ...
                                            availableDays.includes(d) && "bg-orange-500 hover:bg-orange-600"
                                        )}
                                        onClick={() => toggleDay(d)}
                                    >
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="notes">Notes <span className="text-[#EF7B55]">*</span></Label>
                            <Textarea
                                id="notes"
                ...
                <CardFooter className="p-4 sm:p-6 border-t bg-muted/10 flex flex-row justify-end gap-2 sm:gap-4">
                    <Button
                        variant="outline"
                        onClick={() => router.back()}
                        className="px-6"
                    ...
                    <Button
                        ...
                        className="h-10 bg-transparent border border-[#EF7B55] text-[#EF7B55] hover:bg-[#F79771] hover:text-white px-6"
                        disabled={submitting}
                    >
                        {submitting ? (
                            <>
