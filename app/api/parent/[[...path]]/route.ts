...
// ) {
//   const path = params.path ? params.path.join("/") : "";
//   console.log(`[Route] Received POST request to /api/parent/${path}`);
...
//     console.log("[Route] Sending reset password request for childId:", childId);
//     const res = await fetch(`${BASE_URL}/api/parent/reset-child-password/`, {
//       method: "POST",
//       headers: {
//         "X-API-Key": API_KEY,
//         Authorization: `Session ${session.user.sessionToken}`,
