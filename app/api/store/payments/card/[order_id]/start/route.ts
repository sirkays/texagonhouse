...
export async function POST(
  ...
  const fullUrl = `${BASE_URL}/payments/card/${params.order_id}/start`;
  console.log("[StorePaymentStartAPI] Initiating POST to:", fullUrl);
  ...
  try {
    ...
    const normalizedData: PaymentStartResponse = {
